...
//background
const spaceTexture = new THREE.TextureLoader().load("/static/images/space_bg.jpeg")
scene.background = spaceTexture

//mercury
const mercuryTexture= new THREE.TextureLoader().load("/static/images/mercury.jpeg")
const mercuryNormal = new THREE.TextureLoader().load("/static/images/mercury_normal.jpeg")
...
//moon
const moonTexture = new THREE.TextureLoader().load("/static/images/moon.jpeg")
const moonNormal = new THREE.TextureLoader().load("/static/images/moon_normal.jpeg")
